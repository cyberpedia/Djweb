...
- Keyframe Editor GUI for per-layer animations: timeline markers, per-segment easing overrides, parameter curves (x/y/r/s), play/stop preview, drag-to-edit t/x/y, numeric fields for r/s, and live layer preview
