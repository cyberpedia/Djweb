...
- Overlays: title, progress arc, logo (position/size), text overlay; multi-layer overlay system in Template Editor (layer opacity + blend modes; rectangle and progress bar layers)
